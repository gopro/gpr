...
- **Path**: HERO10 night timelapse directory (2022-07-27)
...
- **Path**: HERO10 sunset timelapse directory (2022-07-25)
...
### High-ISO Daylight
- **Path**: HERO10 high-ISO timelapse directory (2022-06-05), file G0030214.GPR
...
- **Path**: Hasselblad X2D 2024 image directory
...
- `<your-path>/hassel/2024_12_Dec_Austin_0137.dng` — ISO 200, 1/250s
- `<your-path>/hassel/2024_12_Dec_Austin_0186.dng` — ISO 64, 1/10s

## Hasselblad X1D / CFV II 50C (8384×6304, 16-bit)

### Longest Exposure Found
- **Path**: Hasselblad X1D 2020 image directory (2020-07-04), file B0010206.3FR
...
- **Path**: Hasselblad X1D 2020 image directory (2020-07-23)
