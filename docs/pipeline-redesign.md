...
Research into EMVA 1288, Wei et al. (CVPR 2020), Imatest, and Dotphoton/Jetraw reveals our current implementation covers the most important noise sources but has gaps in the noise taxonomy and pipeline ordering. This plan corrects the architecture to match the physics-based signal chain.
